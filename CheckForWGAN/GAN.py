...
cilp_D = [p.assign(tf.clip_by_value(p,-0.01,0.01)) for p in theta_D]
...
for it in range(100000):
    for _ in range(5):
        ...
        _,D_loss_curr,_ = sess.run([D_solver,D_loss,cilp_D],feed_dict={X:X_mb,z:sample_z(mb_size,z_dim)})
